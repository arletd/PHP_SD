...
<html>
    ...
    <body>
        ...
        ?>
        <h1>LOS HEROES CON A</h1>
        <?php
        $nombres = mysqli_query($con, "SELECT name FROM heroes WHERE name LIKE 'A%' ");
            if(mysqli_num_rows($nombres)<1){
                exit("No hay clases");
            }
